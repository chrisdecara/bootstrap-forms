...
const correctAnswers = {
      ...
      middlename: "Edwin",
      novelname: "Carrie",
      pseudonym_reason: "Stephen King used the name 'Richard Bachman' in order to bypass the number of novels he could publish per year.",
      novellist: "wolfbynight",
      movielist: [ "thinner", "thelangoliers", "thedeadzone" ],
      earliest_novel: "TheShining"
